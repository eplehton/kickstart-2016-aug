...
#############
# 1) Let's continue with the population data. Read the population data to the a data frame.
...
#
# a) with a largish population (> 50 000) and small population
# b) with an increasing population or an decreasing population.
